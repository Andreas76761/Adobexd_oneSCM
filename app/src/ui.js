/* =========================================================================
   Oberflaeche des Screenarchivs.

   Diese Datei wird vom Build (app/build/build.mjs) zusammen mit core.mjs und
   den Daten in EIN <script>-Element geschrieben. Die Funktionen aus core.mjs
   stehen deshalb hier direkt zur Verfuegung (filtere, sortiere, ...).
   ========================================================================= */
    ...
    gruppen.push(
      el('button', {
        ...
        onclick: () => {
          ...
          zustand = { ...STANDARD_ZUSTAND, sortierung: behalten };
          schreibeHash();
          zeichne();
          $('#suche').value = '';
        }
